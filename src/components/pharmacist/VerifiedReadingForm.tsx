    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1.5">
          <Label className="text-mc-neutral-900 font-body text-sm">Systolic</Label>
          <Input
            type="number"
            min={60}
            max={250}
            ...
            placeholder="e.g. 130"
            className="bg-mc-surface-page border-mc-neutral-200 text-mc-neutral-900"
            required
          />
        </div>
        <div className="space-y-1.5">
          <Label className="text-mc-neutral-900 font-body text-sm">Diastolic</Label>
          <Input
            type="number"
            min={40}
            max={150}
      ...
      <div className="space-y-1.5">
        <Label className="text-mc-neutral-900 font-body text-sm">Reading date</Label>
        <Input
          type="date"
      ...
      {error && <p className="text-mc-danger-600 text-sm font-body">{error}</p>}
